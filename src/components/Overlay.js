  ...
  render() {
    return (
      <div id="overlay">
        ...
        <div id="wefit" className="cover"><a href="javascript:void(0)" onClick={() => this.handleClose(1)}>&times;</a><img src="https://s3-us-west-1.amazonaws.com/brendanmok.herokuapp.com/Screen+Shot+2017-03-08+at+3.52.42+PM.png"/><p>WeFitly is a community driven marketplace for personal training. Depending on what they desire, users can book either a private or group service with a personal trainer set to their schedule. Personal trainers have the option to confirm or reject the booking. Further features would include a review/rating system for each trainer so that users can make a more educated decision on which trainer they would want to book.</p></div>
