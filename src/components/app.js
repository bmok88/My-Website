        ...
        <div id="home">
          ...
          <div id="icons">
            ...
            <div className="icon education">
              <a href="BrendanMok_Resume.pdf" target="_blank">
            ...
            <div className="icon github">
              <a href="https://github.com/bmok88" target="_blank"><img src="GitHub-Mark-Light-64px.png" className="glyphicon github"/>
                <div className="label">GitHub</div>
              </a>
            </div>
            <div className="icon linkedin">
              <a href="https://www.linkedin.com/in/brendan-mok/" target="_blank"><img src="In-White-66px-R.png" className="glyphicon linkedin"/>
