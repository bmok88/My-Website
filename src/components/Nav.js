      ...
      <BrowserRouter>
        <div id="nav">
          <ul>
            ...
            <li><Link to="/" style={{ textDecoration: 'none' }}><img src="http://imgur.com/BPgB3w6"/></Link></li>
            <li><Link to="/" style={{ textDecoration: 'none' }}><img src="http://imgur.com/IoJNZPx"/></Link></li>
          </ul>
        </div>
      </BrowserRouter>
    )
